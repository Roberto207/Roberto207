...
Sou estudante de Bacharelado em Inteligência Artificial na UFG (Goiânia) e desenvolvedor com base sólida em backend Python. Meu foco é IA aplicada: agentes autônomos, RAG e integração de LLMs em produtos reais.
...
🔹 **[FastAPI-Supabase-Pizza-API](https://github.com/Roberto207/FastAPI-Supabase-Pizza-API)** — API REST em produção (deploy ativo)
CRUD completo de pedidos, produtos e usuários, autenticação JWT, documentação OpenAPI/Swagger.
Tecnologias: FastAPI, PostgreSQL, Supabase, Pydantic, JWT
Docs em cloud: https://fastapi-supabase-pizza-api-production.up.railway.app/docs
